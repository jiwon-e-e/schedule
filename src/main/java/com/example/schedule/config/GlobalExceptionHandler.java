...
import com.example.schedule.Exception.InvalidInputException;
import com.example.schedule.Exception.SystemException;
...
//    public ResponseEntity<String> handleServiceException(SystemException ex){
